...
body {
  ...
  `radial-gradient(50% 50% at 50% 30%, ${theme.primary1!=='#2172E5'?'rgb(0 255 126 / 28%)':'rgb(21 61 111 / 65%)'} 0%, ${theme.primary1!=='#2172E5'?'rgb(111 219 236 / 11%)':'rgba(55, 107, 173, 0)'} 100%)`};
}
`
