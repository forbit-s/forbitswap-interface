...
import Logo from '../../assets/images/forbit.png'
import LogoDark from '../../assets/images/forbit.png'
...
const UNIAmount = styled(AccountElement)`
  ...
  background: radial-gradient(174.47% 188.91% at 1.84% 0%, #0fb836 0%, #2172e5 100%), #edeef2;
`
